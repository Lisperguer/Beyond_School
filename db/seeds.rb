...
User.create(email: "felipe.lisperguer@gmail.com", first_name: "Felipe", last_name: "Lisperguer", address: "Siempreviva 123", edad: "27", colegio: "Santa Maria", password: "123456", password_confirmation: "123456")
User.create(email: "flo.lema222@gmail.com", first_name: "Florencia", last_name: "Lema", address: "Calle Falsa 123", edad: "58", colegio: "Santa Catalina", password: "123456", password_confirmation: "123456")

curso1 = Course.create(titulo: "Educacion Sexual", duracion: 10, detalle: "La educación sexual es muy importante, ya que esta proporciona la información y las herramientas necesarias para disfrutar del sexo de manera responsable y saludable")
Course.create(titulo: "Educacion Financiera", duracion: 20, detalle: "La educación financiera es el proceso mediante el cual los individuos adquieren una mejor comprensión de los conceptos y productos financieros, desarrollan las habilidades necesarias para tomar decisiones  informadas, evaluar riesgos y oportunidades financieras")
...
quiz_1 = Quiz.create(nombre: "Quiz Modulo 1", section_id: section_1)
quiz_2 = Quiz.create(nombre: "Quiz Modulo 2", section_id: section_2)

quiz_details_1 = QuizDetail.create(quiz_id: quiz_1, pregunta: "Ahorrar en pesos es considerada una inversion?", respuesta: false)
quiz_details_2 = QuizDetail.create(quiz_id: quiz_1, pregunta: "Ahorrar en pesos es considerada una inversion?", respuesta: false)
quiz_details_3 = QuizDetail.create(quiz_id: quiz_1, pregunta: "Ahorrar en pesos es considerada una inversion?", respuesta: false)
quiz_details_end = QuizDetail.create(quiz_id: quiz_2, pregunta: "Ponele FALSO", respuesta: false)
